...
import { EmojiEvents, NavigateNext } from '@mui/icons-material';
...
const Leaderboard = () => (
  <ThemeProvider theme={theme}>
    <AppShell fullWidth>
        ...
        header={
          <>
            <Breadcrumbs separator={<NavigateNext fontSize="small" sx={{ opacity: 0.5 }} />} sx={{ mb: 1.5 }}>
              ...
              <Typography sx={{ fontSize: '0.75rem', fontWeight: 700, color: 'text.primary' }}>LEADERBOARD</Typography>
            </Breadcrumbs>
      ...
      >
        <LeaderboardContent isLoading={false} />
      </StudentPageLayout>
    </AppShell>
  </ThemeProvider>
);
