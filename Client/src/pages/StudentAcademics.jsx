...
import { School, NavigateNext } from '@mui/icons-material';
import { Link as RouterLink } from 'react-router-dom';

import AppShell from '../components/layout/AppShell';
import StudentPageLayout from '../components/layout/StudentPageLayout';
import AcademicsContent from '../features/academics/AcademicsContent';
...
const StudentAcademics = () => (
  <ThemeProvider theme={theme}>
    <AppShell fullWidth>
        ...
        header={
          <>
            <Breadcrumbs separator={<NavigateNext fontSize="small" sx={{ opacity: 0.5 }} />} sx={{ mb: 1.5 }}>
              ...
              <Typography sx={{ fontSize: '0.75rem', fontWeight: 700, color: 'text.primary' }}>ACADEMICS</Typography>
            </Breadcrumbs>
      ...
      >
        <AcademicsContent isLoading={false} />
      </StudentPageLayout>
    </AppShell>
  </ThemeProvider>
);
